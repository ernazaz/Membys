...
export class IndividualComponent implements OnInit {
    ...
    constructor(private individualService: IndividualService,
        ...
        //this.image$ = this.individualService.getAll();
        this.users$ = this.individualService.getUsers();
       // this.urelas$ = this.individualService.getImage();
    }
    //----------------------------------   ImageProperties  
    ...
    save(form) {
        ...
        console.log(offer1, "done");
        console.log(totalUsers,"Useriai");
       // this.individualService.uploadImage(this.croppedImage.split(/,(.+)/)[1]);
    }
    //---------------------------------------
    //-----------------------------------------------
